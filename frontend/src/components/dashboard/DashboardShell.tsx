...
import { LayoutDashboard, LogOut, Menu, ShieldHalf } from 'lucide-react'
...
// Grows as feature routes are added in B6.4-B6.7.
const NAV: NavItem[] = [{ to: '/dashboard', label: 'Overview', icon: LayoutDashboard }]
