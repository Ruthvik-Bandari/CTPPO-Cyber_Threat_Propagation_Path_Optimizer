...
CTPPO (Cyber Threat Propagation Path Optimizer) is a proprietary enterprise cybersecurity platform that leverages advanced Machine Learning, Graph Neural Networks, and the NAMOA* multi-objective optimization algorithm to identify, analyze, and prioritize cyber attack paths in network infrastructures.
...
| Metric | Score |
|--------|-------|
| CVE Severity Classification F1 Score | **97.50%** |
...
### AI-Powered Analysis
- CVE Severity Classifier with 97.50% F1 score using fine-tuned transformer models
- Graph Neural Network for attack propagation prediction through network topology
- Reinforcement Learning for optimized defensive resource allocation
